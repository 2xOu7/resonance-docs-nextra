...
<Theme>
    ...
    <p>
        ...
        <strong>{`{your_domain}`}.useresonance.com.)</strong>
    </p>
    <br />
    <Blockquote>
    ...
    <Blockquote>
        ...
        <strong>Below Navigation Bar</strong> in the{' '}
        <strong>Slot</strong> dropdown - the dropdown menu is
    ...
    <br />
    <Blockquote>
        Select <strong>Embedded Home Page Banner</strong> in the first dropdown for each variant. In the future, you can experiment with multiple format types per campaign for the slot that you chose initially.
    </Blockquote>
    <br/>
    <Blockquote>
