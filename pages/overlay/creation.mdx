...
<Theme>
    ...
    <Blockquote>
        Select{' '}
        <strong>Modal</strong> as an option in the first dropdown for each variant - the
        dropdown menu is populated based on the application
        settings JSON <strong>overlayFormats</strong> field. In the future, you can experiment with multiple format types per variant.
    </Blockquote>
    <br/>
    <Blockquote>
